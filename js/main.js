...
const templatePreviaArticulo =
  document.querySelector("#previa-articulo").content.firstElementChild;
...
async function obtenerArticulos() {
  //Mostramos una distracion visual al usuario
  ...
  //Cuando el servidor o la API ya nonos da más información, dejamos de pasar de página.
  //En otras palabras, detenemos el observador que es quien decide cuando cambiar de página.
  if (json.length === 0){
